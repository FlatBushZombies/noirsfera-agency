            ...
            >
              ...
              <div className="hidden md:flex items-center gap-3 flex-shrink-0">
                ...
                >
                  ...
                  >
                    <Button className="bg-[#0BACFF] hover:bg-[#00C7E6] text-white font-semibold font-sans rounded-full px-6 py-2.5 text-sm relative overflow-hidden h-auto group transition-all duration-300 shadow-lg hover:shadow-xl border-0">
                      <motion.span
                        initial={false}
                        animate={{
